...
final class LoadNewsUseCaseTests: XCTestCase {
    
    var urlSession: URLSession!
    var service: NetworkServiceProtocol!
    var sut: LoadNewsUseCase!
    var route: Router!
    ...
    override func setUpWithError() throws {
        ...
        sut = DefaultLoadNewsUseCase(repository: DefaultNewsRepository(networkService: service))
